// const header = `Stay overnight on the most beautiful harbour in the world with a view to the Harbour Bridge and Sydney Opera House on board your very own, completely private, luxury yacht! We can even take you on a private guided-tour harbour cruise. No boating experience needed. Thanks to all the wonderful reviews we've received, the yacht is now listed as Airbnb's #1 place to stay anywhere in Sydney and is rated by the Sydney Morning Herald as one of the top three "most amazing" places to stay in Australia.`

// const details = `The space
