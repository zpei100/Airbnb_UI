module.exports = [
  ...
  {
    header: `Your own fully self-contained spacious Bondi apartment! The 3 double bedroom Apartment has Sea Views & only 100 metres to the Pacific Ocean, minutes from world famous Bondi Beach, Bronte Coastal Walk & Bondi cafe, restaurant, shopping & bar strip.

    Lots happening in Bondi in summer!
    
    More information
    With 150+ positive reviews we aim to ensure your experience exceeds expectations`,
    details: `Your own fully self-contained 3 bedroom sunny apartment with sweeping views of Bondi Beach & Pacific Ocean
    
    Living/Dining Room. open plan with sweeping views out over Bondi and the Pacific Ocean. Walk out to one of two balcony's or just open the French style doors and enjoy the sea breeze! Plenty of comfortable seating and a dining table for 6.
    Master bedroom 1. Extra-large bedroom with queen size double bed, full length built in wardrobes, plush carpet and views of the Pacific Ocean. 
    Bedroom 2. Bedroom with double bed, built in wardrobes, plush carpet and with views of the Pacific Ocean. 
    Loft bedroom 3. A large space on the second level with a queen size double bed, bookcase, plush carpet and a convertible single bed if needed. Check out the sweeping views of Bondi Beach and the Pacific Ocean from the 3 attic style windows!!
    Kitchen. A full kitchen with oven, electric stove, benches, fridge and all your dining and cooking needs! Nespresso Machine!
    ...
    www.airbnb.com.au/c/nseale`
  },
  {
    header: `This gorgeous 3-bedroom apartment is directly across the road from the beach. It's very light, beautifully decorated and all within minutes of Bondi, Bronte, restaurants, shops and buses to the CBD. Watch the waves as you have a drink on the balcony.`,
    details: `Here are a few of the highlights of The BEACHFRONT Apartment:
  ...
  {
    header: `An entire terrace , right in the middle of Surry Hills. Lovingly restored with many original features makes for a really lovely, homey feeling. The house is so spacious and tranquil you will almost forget that you are in the inner city of Sydney.`,
    details: `A large original Victorian terrace, spread over 3 levels, lovingly restored ensures a warm welcome and charming stay. With 4 large bedrooms (three Queens & a double ) and a fully functioning 2nd bathroom in the master bedroom. A spacious living area downstairs combines comfortable lounge / TV area & casual dining with a huge table for your gatherings.Main bathroom is on the ground level, original with huge bath and separate shower & WC. Well equipped kitchen and a washing machine for guest use. 
  ...
  {
    header: `Beautifully furnished and decorated home.Situated in vibrant Woollahra with amazing shops restaurants and pubs, adjacent to the beautiful Centennial Park, walk or bus to Bondi beach and the city(10mins). Also a short walk to the SCG for cricket fans`,
    details: `A beautifully decorated home in a fantastic location close to all amenities. This home has the perfect aspect that captures light and cooling summer sea breezes. Everything walkable, no need for a car! Easily accommodates two couples or a family of 5. One exclusive bathroom, owners live in separate rear studio which has its own entrance,and access to 2nd bathroom which can be shared with owners. Please note Guest access!
  ...
  {
    header: `It's a basic, simple and tidy two bedroom apartment with a bird’s eye view of Opera House & glimpse of Harbour. Centrally located, close to everything, Hyde Park is literally at your doorstep. The Museum Station (link to Airport) is 350 meters away, 5 mins stroll.`,
    details: `--Maximum for 6 guests 
    ...
    --No air-conditioning, it is broken and can’t be repaired
  ...
  {
    header: `An ENTIRE apartment unit ALL TO YOURSELF in the heart of Sydney's CBD marks this exquisite inner-city abode a must for any weekenders, interstaters or holiday makers. Fully furnished with FREE Wi-Fi!

    BOOK NOW and receive 15% OFF car rentals with Europcar across Australia, New Zealand & UK wide!`,
    details: `Extremely spacious for 1, roomy for 2, great for 3, accommodates a maximum of 4.
